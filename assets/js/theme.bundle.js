    ...
    var e, t = {
                ...
                function() {
                    ...
                    for (let t = 0; t < e.length; t++) {
                        const a = e[t].split("="),
                            o = a[0],
                            n = a[1];
                        "colorScheme" != o && "navPosition" != o && "navColor" != o && "sidebarSize" != o || (localStorage.setItem("dashkit" + o.charAt(0).toUpperCase() + o.slice(1), n), v[o] = n)
                    }
            ...
            524: (e, t, a) => {
                ...
                document.querySelectorAll("[data-dropzone]").forEach((e => {
                    ...
                    e.querySelector(".dz-preview").innerHTML = "", new(u())(e, n)
                })), window.Dropzone = u();
                var p = a(527);
                ...
                b().registerLanguage("xml", y()), b().registerLanguage("javascript", m()), k.forEach((e => {
                    b().highlightBlock(e)
                })), window.hljs = b();
                var g = a(90),
                    S = a.n(g);
                ...
                const N = {
                    ...
                    P = "Cerebri Sans",
                    z = document.querySelectorAll('[data-toggle="chart"]'),
                    B = document.querySelectorAll('[data-toggle="legend"]');
                ...
                T.kL.defaults.responsive = !0, T.kL.defaults.maintainAspectRatio = !1, T.kL.defaults.color = J("--bs-chart-default-color"), T.kL.defaults.font.family = P, T.kL.defaults.font.size = 13, T.kL.defaults.layout.padding = 0, T.kL.defaults.plugins.legend.display = !1, T.kL.defaults.elements.point.radius = 0, T.kL.defaults.elements.point.backgroundColor = N.primary[700], T.kL.defaults.elements.line.tension = .4, T.kL.defaults.elements.line.borderWidth = 3, T.kL.defaults.elements.line.borderColor = N.primary[700], T.kL.defaults.elements.line.backgroundColor = N.transparent, T.kL.defaults.elements.line.borderCapStyle = "rounded", T.kL.defaults.elements.bar.backgroundColor = N.primary[700], T.kL.defaults.elements.bar.borderWidth = 0, T.kL.defaults.elements.bar.borderRadius = 10, T.kL.defaults.elements.bar.borderSkipped = !1, T.kL.defaults.datasets.bar.maxBarThickness = 10, T.kL.defaults.elements.arc.backgroundColor = N.primary[700], T.kL.defaults.elements.arc.borderColor = J("--bs-chart-arc-border-color"), T.kL.defaults.elements.arc.borderWidth = 4, T.kL.defaults.elements.arc.hoverBorderColor = J("--bs-chart-arc-hover-border-color"), T.kL.defaults.plugins.tooltip.enabled = !1, T.kL.defaults.plugins.tooltip.mode = "index", T.kL.defaults.plugins.tooltip.intersect = !1, T.kL.defaults.plugins.tooltip.external = M, T.kL.defaults.plugins.tooltip.callbacks.label = $, T.kL.defaults.datasets.doughnut.cutout = "83%", T.kL.overrides.doughnut.plugins.tooltip.callbacks.title = function(e) {
                    ...
                    drawOnChartArea: !1,
                    drawTicks: !1
                }, T.kL.defaults.scales.category.ticks.padding = 20, z.forEach((function(e) {
                ...
                const j = document.getElementById("audienceChart");
                j && new T.kL(j, {
                    type: "line",
                    options: {
                        scales: {
                ...
                const F = document.getElementById("conversionsChart");
                F && new T.kL(F, {
                    type: "bar",
                    options: {
                        scales: {
                    ...
                    data: {
                        labels: ["Окт 1", "Окт 2", "Окт 3", "Окт 4", "Окт 5", "Окт 6", "Окт 7", "Окт 8", "Окт 9", "Окт 10", "Окт 11", "Окт 12"],
                        datasets: [{
                            label: "2020",
                ...
                W && new T.kL(W, {
                    ...
                    data: {
                        labels: ["PHP 8.0.7", "Java: Java SE 16.0.1", "Ruby on rails 6.1.3.2"],
                        datasets: [{
                            data: [60, 25, 15],
                ...
                const U = document.getElementById("trafficChartAlt");
                U && new T.kL(U, {
                    type: "doughnut",
                    options: {
                        plugins: {
                ...
                Z && new T.kL(Z, {
                    ...
                    data: {
                        labels: ["Окт 1", "Окт 3", "Окт 6", "Окт 9", "Окт 12", "Окт 5", "Окт 18", "Окт 21", "Окт 24", "Окт 27", "Окт 30"],
                        datasets: [{
                            label: "Все",
                ...
                R && new T.kL(R, {
                    ...
                    data: {
                        labels: ["Янв", "Февр", "Март", "Апр", "Май", "Июнь", "Июль", "Авг", "Сент", "Окт", "Ноя", "Дек", "Янв", "Февр", "Март", "Апр", "Май", "Июнь"],
                        datasets: [{
                            label: "Earnings",
    ...
    o.m = t, e = [], o.O = (t, a, n, r) => {
        if (!a) {
            ...
            for (i = 0; i < e.length; i++) {
                for (var [a, n, r] = e[i], s = !0, c = 0; c < a.length; c++)(!1 & r || l >= r) && Object.keys(o.O).every((e => o.O[e](a[c]))) ? a.splice(c--, 1) : (s = !1, r < l && (l = r));
                s && (e.splice(i--, 1), t = n())
            }
            return t
        }
